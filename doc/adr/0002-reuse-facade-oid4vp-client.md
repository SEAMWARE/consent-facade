...
**Context doc:** [`CONSENT_MANAGEMENT.md`](https://github.com/FIWARE/data-space-connector/blob/main/doc/CONSENT_MANAGEMENT.md)

> :information_source: **Mirrored ADR.** The canonical copy lives in
> [FIWARE/data-space-connector](https://github.com/FIWARE/data-space-connector/blob/main/doc/adr/README.md) `doc/adr/`; it is duplicated here because it
> constrains this repository's API. Change it there first.

## Context

[ADR-0001](https://github.com/FIWARE/data-space-connector/blob/main/doc/adr/0001-oid4vp-for-participant-authentication.md) requires the provider to obtain an OID4VP
...
1. **The DSC uses the FIWARE/DSBA `vp_token` grant**, not the plain OID4VP presentation flow. The
   ...
   [`get_access_token_oid4vp.sh`](https://github.com/FIWARE/data-space-connector/blob/main/doc/scripts/get_access_token_oid4vp.sh).
